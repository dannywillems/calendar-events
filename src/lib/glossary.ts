...
const DESCRIPTIONS: Record<string, string> = {
  ...
  defensive: 'Defensive security: blue team, detection, incident response.',
  hacking: 'Hacker-community topics, hands-on exploitation, CTFs.',
  'threat-intel': 'Threat intelligence: tracking actors, campaigns, and IOCs.',
  osint: 'Open-source intelligence gathering and investigation.',
  'attack-surface': 'External attack surface, internet scanning, exposure.',
  grc: 'Governance, risk, and compliance.',
  privacy: 'Data protection and privacy.',
  cloud: 'Cloud security.',
  appsec: 'Application and software security.',
  hardware: 'Hardware and embedded security.',

  // industry verticals
  'ics-ot': 'Industrial control systems and operational technology security.',
  healthcare: 'Healthcare and medical-device security.',
  aviation: 'Aviation and aerospace security.',
  automotive: 'Automotive and connected-vehicle security.',
  finance: 'Financial-sector and banking security.',
  energy: 'Energy, utilities, and grid security.',
  maritime: 'Maritime and shipping security.',
  defense: 'Defense, military, and national-security topics.',
  government: 'Government and public-sector security.',
  telecom: 'Telecommunications security.',
